...
{
       0,    68,    68,    74,    68,    80,    81,    84,    85,    86,
      91,   100,   115,   123,   132,   140,   157,   174,   187,   196,
     207,   221,   234,   247,   255,   270,   285,   299,   318,   324,
     331,   345,   351,   352,   356
};
#endif
...
#line 1293 "algosipro.tab.c"
    break;

  case 16: /* if: %empty  */
#line 157 "algosipro.y"
     {
	int n = numero_label();
	push(n);
...
#line 1313 "algosipro.tab.c"
    break;

  case 17: /* else: %empty  */
#line 174 "algosipro.y"
       {
	char* buf = malloc(MAXBUF);
	int n = top();
	create_label(buf, MAXBUF, "else_%u", n);
...
#line 1329 "algosipro.tab.c"
    break;

  case 18: /* fi: %empty  */
#line 187 "algosipro.y"
     {
	int n = top();
	char* buf = malloc(MAXBUF);
...
#line 1373 "algosipro.tab.c"
    break;

  case 21: /* fwhile: %empty  */
#line 221 "algosipro.y"
         {
	int n = top();
	char* buf = malloc(MAXBUF);
...
#line 1405 "algosipro.tab.c"
    break;

  case 23: /* expr: NUMBER  */
#line 247 "algosipro.y"
         {
	printf( "; Number %d\n"
...
#line 1417 "algosipro.tab.c"
    break;

  case 24: /* expr: expr '+' expr  */
#line 255 "algosipro.y"
                {
...
#line 1436 "algosipro.tab.c"
    break;

  case 25: /* expr: expr '-' expr  */
#line 270 "algosipro.y"
                {
    if ((yyvsp[-2].s) != NUM || (yyvsp[0].s) != NUM) {
		fprintf(stderr, "Erreur de type \n");
		(yyval.s) = TYPE_ERR;
...
#line 1455 "algosipro.tab.c"
    break;

  case 26: /* expr: expr '*' expr  */
#line 285 "algosipro.y"
                  {
	if ((yyvsp[-2].s) != NUM || (yyvsp[0].s) != NUM) {
		fprintf(stderr, "Erreur de type \n");
		(yyval.s) = TYPE_ERR;
...
#line 1496 "algosipro.tab.c"
    break;

  case 28: /* expr: VRAI  */
#line 318 "algosipro.y"
       {       
	printf("\tconst ax,1\n"); 
        printf("\tpush ax\n");
        (yyval.s)=TYPE_BOOL;
...
#line 1506 "algosipro.tab.c"
  ...
  case 29: /* expr: FAUX  */
#line 324 "algosipro.y"
       {  
	printf("\tconst ax,0\n");
        printf("\tpush ax\n");
        (yyval.s)=TYPE_BOOL;
    }
#line 1516 "algosipro.tab.c"
    break;

  case 30: /* expr: CALL '{' VARNAME '}' '{' lexpr '}'  */
#line 331 "algosipro.y"
                                     {
...
#line 1534 "algosipro.tab.c"
    break;

  case 31: /* expr: '(' expr ')'  */
#line 345 "algosipro.y"
               {
	(yyval.s) = (yyvsp[-1].s);
}
#line 1542 "algosipro.tab.c"
    break;

  case 34: /* tmp_expr: expr  */
#line 356 "algosipro.y"
             {
		++argument;
	}
#line 1550 "algosipro.tab.c"
    break;


#line 1554 "algosipro.tab.c"
